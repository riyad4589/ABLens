        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 18 }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              <button style={{ background: '#ff4d4f', color: '#fff', border: 'none', borderRadius: 8, padding: '10px 22px', fontWeight: 700, fontSize: 17, display: 'flex', alignItems: 'center', gap: 8, boxShadow: '0 2px 8px rgba(24,49,83,0.08)', cursor: 'pointer' }} onClick={() => {/* action close ticket */}}><MdClose style={{ fontSize: 22 }} /> Close Ticket <span style={{ fontSize: 14, marginLeft: 2, marginTop: 2 }}>▼</span></button>
              <button style={{ background: '#ff4d4f', color: '#fff', border: 'none', borderRadius: '50%', width: 44, height: 44, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, marginLeft: 8, boxShadow: '0 2px 8px rgba(24,49,83,0.08)', cursor: 'pointer' }} onClick={() => navigate('/tickets')} title="Retour à la liste des tickets">
                <MdClose />
              </button>
            </div>
          </div>
